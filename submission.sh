#!/bin/bash
repo_url=https://github.com/SriSurya06/Build-Secure-PKI-Based-2FA-Microservice-with-Docker
...
echo "Docker image URL for evaluation: srisurya06/build-secure-pki-based-2fa-microservice-with-docker-app:latest"
echo "Docker Hub link: https://hub.docker.com/r/srisurya06/build-secure-pki-based-2fa-microservice-with-docker-app"